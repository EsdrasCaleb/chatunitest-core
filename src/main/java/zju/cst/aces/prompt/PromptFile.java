...
public enum PromptFile {
    ...
    chattester_init("PROMPT_TEMPLATE_CHATTESTER_INIT", "PROMPT_TEMPLATE_SYSPROMPT_CHATTESTER_INIT"),
    chattester_repair("PROMPT_TEMPLATE_CHATTESTER_REPAIR", "PROMPT_TEMPLATE_SYSPROMPT_CHATTESTER_INIT"),
    chattester_extra("PROMPT_TEMPLATE_CHATTESTER_EXTRA", "PROMPT_TEMPLATE_SYSPROMPT__CHATTESTER_EXTRA"),
